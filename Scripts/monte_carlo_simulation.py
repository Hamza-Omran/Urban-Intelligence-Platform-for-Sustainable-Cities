...
# ================================================================
class Config:
    """Configuration class for Monte Carlo simulation"""
    ...
    # Scenario thresholds (as per project requirements)
...
def load_merged_data():
    """Load merged dataset from Member 4"""
    print("\n" + "="*70)
...
def define_scenarios():
    """Define weather scenarios for simulation"""
    print("\n" + "="*70)
...
def analyze_scenarios_in_data(df, scenarios):
    """Analyze how often each scenario occurs in the dataset"""
    print("\n" + "="*70)
...
def calculate_congestion_probability(weather_severity, traffic_intensity, 
    ...
    """Calculate probability of traffic jam"""
...
def analyze_by_scenario(simulation_results, scenarios):
    """Analyze results by weather scenario"""
    print("\n" + "="*70)
